...
import com.mycompany.AuthorizationServer.ntlm.AuthNtlmType3Handler;
import com.mycompany.AuthorizationServer.ntlm.NtlmManager;
import com.mycompany.AuthorizationServer.telemetry.ClientsBrowserAnalyzer;
import com.mycompany.AuthorizationServer.telemetry.ServerResponseTimeAnalizer;
import com.mycompany.HttpsServer.HttpsClient;
...
public class HttpRequestHandler implements Runnable {
     ...
     * @throws Exception
     */
    public void dawnloadFromInet(String header, String host, int port) throws Exception {
